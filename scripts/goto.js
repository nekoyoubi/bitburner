...
export async function main(ns) {
	...
	//while (!ns.fileExists("map.txt") && !ns.isRunning("map.js", "home")) await ns.sleep(10);
	let hostname = ns.getHostname();
	if (hostname != "home") await ns.scp("map.txt", "home", hostname);
	...
	for (let r in route) {
		...
		//if (route[r].host != "home")
			ns.singularity.connect(route[r].host);
